 ...
 */
public class MinesweeperFieldCellClosedView extends EndlessFieldCellView<MinesweeperFieldCell> {
    private boolean isOpen = false;

    private MinesweeperFieldCellClosedView() {}

    public MinesweeperFieldCellClosedView(MinesweeperFieldCell viewSource) {}

    @Override
    public EndlessCellCloneFactory cloneFactory() {
        return source -> new MinesweeperFieldCellClosedView();
    }
}
