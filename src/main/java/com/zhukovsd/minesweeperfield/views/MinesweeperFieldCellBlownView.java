...
/**
 * Created by ZhukovSD on 23.08.2016.
 */
public class MinesweeperFieldCellBlownView extends EndlessFieldCellView<MinesweeperFieldCell> {
    private boolean mineBlown = true;

    private MinesweeperFieldCellBlownView() {}

    public MinesweeperFieldCellBlownView(MinesweeperFieldCell viewSource) {}

    @Override
    public EndlessCellCloneFactory cloneFactory() {
        return source -> new MinesweeperFieldCellBlownView();
    }
}
